...
class TestRegister(BaseTest):
    def test_register_with_mandatory_fields(self):
        ...
        account_success_page = register_page.register_an_account(
            ExcelUtils.get_cell_data("ExcelFiles/TutorialsNinja.xlsx",
                                     "RegisterTest", 2, 1),
            ExcelUtils.get_cell_data("ExcelFiles/TutorialsNinja.xlsx",
                                     "RegisterTest", 2, 2),
    ...
    def test_register_with_duplicate_email(self):
        home_page = HomePage(self.driver)
        register_page = home_page.navigate_to_register_page()
        register_page.register_an_account("Arun", "Motoori", "amotooricap3@gmail.com", "1234567890", "12345", "12345",
                                          "yes",
                                          "select")
    ...
    def test_register_without_entering_any_fields(self):
        ...
        assert register_page.verify_all_warnings("Warning: You must agree to the Privacy Policy!", "First Name must be "
                                                 ...
                                                 "Last Name must be between 1 and 32 characters!", "E-Mail Address "
                                                                                                   "does not appear to "
                                                                                                   "be valid!",
                                                 "Telephone must be between 3 and 32 characters!", "Password must be "
                                                                                                   "between 4 and 20 "
                                                                                                   "characters!")
